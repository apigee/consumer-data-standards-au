...
exports.performanceRequestOptions = {
    apiPathSuffix: '/stats/dc_MeetsPerformanceSLO',
    method: 'GET',
    body: null,
    params: {
        tsAscending: false,
        ...
        timeUnit: 'day',
        filter: "(dc_MeetsPerformanceSLO ne '(not set)')"
    }
}

exports.invocationAndAvgResponseRequestOptions = {
    apiPathSuffix: '/stats/dc_PerformanceTier',
    method: 'GET',
    body: null,
    params: {
        tsAscending: false,
...
exports.errorAndRejectionRequestOptions = {
    apiPathSuffix: '/stats/response_status_code,dc_PerformanceTier',
    method: 'GET',
    body: null,
    params: {
        tsAscending: false,
        ...
        select: 'sum(message_count)',
        timeUnit: 'day',
        filter: "(dc_MeetsPerformanceSLO ne '(not set)' and ( response_status_code eq 429 or response_status_code ge 500) )"
    }
}
...
exports.customerAndRecipientRequestOptions = {
    apiPathSuffix: '/stats/client_id,dc_CustomerPPId,dc_TokenOp',
    method: 'GET',
    body: null,
    params: {
        tsAscending: false,
        tzo: exports.defaultOptions.tzo,
        select: 'sum(message_count)',
        filter: "(apiproxy eq 'oidc')  and (dc_CustomerPPId ne 'n/a') and (dc_CustomerPPId ne '(not set)') and (dc_TokenOp in 'acquire', 'refresh', 'expire')"
    }
}
