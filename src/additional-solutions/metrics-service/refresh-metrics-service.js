...
exports.refreshDailyAndCurrentMetrics = async function (fromDate, toDate) {
  ...
  // Get Apigee Config
  const apigeeConfig = await metricsServiceUtils.getApigeeConfig();
  ...
  performanceRequestOptions.qs.timeRange = timeRange;
  defaultOptions.debug && console.log("Will update performance metrics. Set time range to: " + performanceRequestOptions.qs.timeRange);
  ...
  // Add time query params
  sessionCountRequestOptions.qs.timeRange = timeRange;
  defaultOptions.debug && console.log("Will update session count metrics. Set time range to: " + sessionCountRequestOptions.qs.timeRange);
  ...
  // Add time query params
  errorAndRejectionRequestOptions.qs.timeRange = timeRange;
  defaultOptions.debug && console.log("Will update error and rejection metrics. Set time range to: " + errorAndRejectionRequestOptions.qs.timeRange);
  ...
  // Add time query params
  avgTpsRequestOptions.qs.timeRange = timeRange;
  defaultOptions.debug && console.log("Will update average TPS metrics. Set time range to: " + avgTpsRequestOptions.qs.timeRange);
  ...
  // Add time query params
  peakTpsRequestOptions.qs.timeRange = timeRange;
  defaultOptions.debug && console.log("Will update peak TPS metrics. Set time range to: " + peakTpsRequestOptions.qs.timeRange);
  ...
  // Add time query params
  invocationAndAvgResponseRequestOptions.qs.timeRange = timeRange;
  defaultOptions.debug && console.log("Will update invocation and average response metrics. Set time range to: " + invocationAndAvgResponseRequestOptions.qs.timeRange);
  ...
  customerAndRecipientRequestOptions.qs.timeRange = newFromDate + '~' + newToDate;
  defaultOptions.debug && console.log("Will update customerCount and recipientCount metrics. Set time range to: " + customerAndRecipientRequestOptions.qs.timeRange);
